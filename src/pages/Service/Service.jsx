...
const Service = () => {
  return (
    <section id="direction" className="container py-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <div
          ...
          className="bg-blue-100 rounded-md flex flex-col gap-5 px-10 py-11"
        >
          <img
            className="w-[50px]"
        ...
        <div className="bg-blue-100 rounded-md flex flex-col gap-5 px-10 py-11">
          <img
            className="w-[50px]"
